// Patched version of Hashcash that fixes variable scoping issues
// Original from: http://www.hashcash.org/docs/hashcash.html

// Patched Hashcash constructor with proper variable declarations
...
Hashcash.setup = function() {
  if (document.readyState != "loading") {
    var input = document.querySelector("input[data-hashcash]")
...
Hashcash.hexSha1 = function(msg) {
  ...
  return cvt_hex(array[0]) + cvt_hex(array[1]) + cvt_hex(array[2]) + cvt_hex(array[3]) + cvt_hex(array[4])
}
