class JobAlertMailer < ApplicationMailer
  def confirmation_email(job_alert_filter)
    ...
    @confirmation_url = confirm_job_alert_url(id: @job_alert_filter.confirmation_token)
    @manage_url = manage_job_alert_url(management_token: @job_alert.management_token)
