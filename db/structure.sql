...
CREATE TABLE IF NOT EXISTS "job_offers" ("id" ulid DEFAULT (ulid()) NOT NULL PRIMARY KEY, "title" varchar, "location" varchar, "category" varchar, "application_type" varchar, "application_destination" varchar, "expires_at" datetime(6), "expires_manually" datetime(6), "featured" boolean, "approved" boolean DEFAULT 0 NOT NULL, "terms_and_conditions" boolean DEFAULT 0, "employer_id" ulid NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, "company_name" varchar /*application='JobBoard'*/, CONSTRAINT "fk_rails_5aaea6c8db"
...
CREATE TABLE IF NOT EXISTS "vouchers" ("id" ulid DEFAULT (ulid()) NOT NULL PRIMARY KEY, "code" varchar NOT NULL, "options" json DEFAULT '{}', "enabled_till" datetime(6) DEFAULT '2225-06-26 21:56:59.206409', "type" varchar, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL);
