...
CREATE TABLE IF NOT EXISTS "job_offers" ("id" ulid DEFAULT (ulid()) NOT NULL PRIMARY KEY, "title" varchar, "region" varchar, "subregion" varchar, "overcategory" varchar, "category" varchar, "application_type" varchar, "application_destination" varchar, "expired_on" datetime(6), "expired_manually" datetime(6), "featured" boolean, "approved" boolean DEFAULT 0 NOT NULL, "terms_and_conditions" boolean DEFAULT 0, "type" varchar, "employer_id" ulid NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, "company_name" varchar /*application='JobBoard'*/, "slug" varchar /*application='JobBoard'*/, CONSTRAINT "fk_rails_5aaea6c8db"
...
CREATE TABLE IF NOT EXISTS "vouchers" ("id" ulid DEFAULT (ulid()) NOT NULL PRIMARY KEY, "code" varchar NOT NULL, "options" json DEFAULT '{}', "enabled_till" datetime(6) DEFAULT '2225-07-22 21:22:11.365387', "type" varchar, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL);
